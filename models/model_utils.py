...
class TransLayer(nn.Module):
    ...
    def __init__(self, norm_layer=nn.LayerNorm, dim=512):
        ...
        self.attn = NystromAttention(
            ...
            dim_head = dim//8,
            heads = 8,
            num_landmarks = dim//4,    # number of landmarks, default: dim//2
...
#自注意力近似实现版
class NystromTransformerEncoderLayer(nn.Module):
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, activation='relu'):
        ...
        self.self_attn = NystromAttention(
            ...
            heads = nhead,
            num_landmarks = d_model//4,    # number of landmarks, default: d_model//2
            pinv_iterations = 6,    # number of moore-penrose iterations for approximating pinverse. 6 was recommended by the paper
            residual = True,         # whether to do an extra residual with the value or not. supposedly faster convergence if turned on
            dropout = dropout         #default：dropout=0.1
        )
